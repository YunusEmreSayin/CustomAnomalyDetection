...
from SerkonAnomalib.callbacks.normalization.base import NormalizationCallback
...
from SerkonAnomalib.callbacks.visualizer import _VisualizationCallback
from SerkonAnomalib.base import AnomalibDataModule, AnomalibDataset
from SerkonAnomalib.data.predict import PredictDataset
from SerkonAnomalib.deploy import CompressionType
from SerkonAnomalib.models.components.base.anomaly_module import AnomalyModule
#from SerkonAnomalib.normalization import NormalizationMethod
from SerkonAnomalib.utils.types import NORMALIZATION, THRESHOLD
from SerkonAnomalib.utils.visualization import ImageVisualizer
...
class Engine:
    ...
    def __init__(
        ...
        default_root_dir: str | Path = "serkon",
        **kwargs,
    ) -> None:
    ...
    def _setup_workspace(
        ...
        #root_dir = Path("serkon")
        #self._cache.args["default_root_dir"] = root_dir
    ...
    def _setup_anomalib_callbacks(self) -> None:
        ...
        for cb in _callbacks:
            print(
                f"[LOG] Callback info--> Callback Name: {cb} |  Callback State: {hasattr(cb, 'state_dict')} | Instance State:{isinstance(cb, Callback)} | Type Of Callback: {type(cb)}")
    ...
    def _should_run_validation(
        ...
        if model.learning_type=='one_class':
            return False
    ...
    def predict(
        ...
        Args:
            ...
            dataset (Dataset | PredictDataset | None, optional):
                A :class:`~torch.SerkonAnomalib.data.Dataset` or :class:`~anomalib.data.PredictDataset` that will be used
    ...
    def export(
        ...
        export_file_name: str | Path |None=None,
        ...
        Args:
            ...
            export_file_name(str | Path |None): Name of the output file->(export_file_name.pt)
