...
from SerkonAnomalib.data.utils.augmenter import Augmenter
from SerkonAnomalib.data.utils.split import Split
...
class SyntheticAnomalyDataset(AnomalibDataset):
    ...
    def __init__(self, task: str, transform: Compose, source_samples: DataFrame) -> None:
