...
from SerkonAnomalib.data.base.dataset import AnomalibDataset
from SerkonAnomalib.data.utils.label import LabelName
from SerkonAnomalib.data.utils.boxes import masks_to_boxes
from SerkonAnomalib.data.utils.image import read_depth_image
...
class AnomalibDepthDataset(AnomalibDataset, ABC):
    ...
    def __init__(self, task: str, transform: Transform | None = None) -> None:
