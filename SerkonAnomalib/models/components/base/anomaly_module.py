...
from SerkonAnomalib.metrics.collection import AnomalibMetricCollection
from SerkonAnomalib.metrics.threshold.base import BaseThreshold
...
class AnomalyModule(ExportMixin, pl.LightningModule, ABC):
    ...
    def from_config(
        ...
        **kwargs,
        ...
        model_parser.add_argument("--task", type=str | str, default='classification')
