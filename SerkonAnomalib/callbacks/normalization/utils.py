"""Normalization callback SerkonAnomalib."""
...
from SerkonAnomalib.utils.normalization import NormalizationMethod
from SerkonAnomalib.utils.types import NORMALIZATION
...
def _parse_normalizer_config(normalization_method: DictConfig) -> Callback:
    ...
    if len(class_path.split(".")) == 1:
        module_path = "anomalib.SerkonAnomalib.callbacks.normalization"
    else:
